...
## 🧩 Dependencies
The Vault Engine has no runtime dependencies on other engines. Its public APIs are documented in `docs/ENGINE_DEPENDENCIES.md` and consumed by components like Gateway and Execution.
